...
if (count($sqlArr)) {
  $count_sql = "SELECT * FROM `users` WHERE $sql ORDER BY `id` DESC";
  $result_sql = "SELECT * FROM `users` WHERE $sql ORDER BY `id` DESC LIMIT $offset , $records_no_per_page";
} else {
  $count_sql = "SELECT * FROM `users` WHERE 1 ORDER BY `id` DESC";
  $result_sql = "SELECT * FROM `users` WHERE 1 ORDER BY `id` DESC LIMIT $offset , $records_no_per_page ";
}
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  <input class="form-control" type="text" name="id" id="id" value="<?php
                  if (isset($_GET['id'])) {
                    echo $_GET['id'];
                  } else {
                    echo '';
        ...
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">
              <i class="fa fa-th-list fa-fw"></i>Users
              <span class="pull-right" style="margin-top: -7px;">
                <a id="add_property_button" type="button" name="button" class="btn btn-success" href="add_user.php">
            ...
            <div class="panel-body">
              ...
              <div class="table-responsive" id="reportData">
                <table class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr class="info">
                      <th colspan="15" class="text-center"> Users</th>
                    </tr>
                    <tr>
                      <th>ID</th>
                      <th>Date</th>
                  ...
                  <tbody>
                    ...
                    foreach ($table_rows as $row) { ?>
                      <tr>
                        ...
                        <td>
                          <a href="detail_user.php?user_id=<?php echo $row->id; ?>"
