...
if (count($sqlArr)) {
  $count_sql = "SELECT * FROM `medical` WHERE $sql ORDER BY `id` DESC";
  $result_sql = "SELECT * FROM `medical` WHERE $sql ORDER BY `id` DESC LIMIT $offset , $records_no_per_page";
} else {
  $count_sql = "SELECT * FROM `medical` WHERE 1 ORDER BY `id` DESC";
  $result_sql = "SELECT * FROM `medical` WHERE 1 ORDER BY `id` DESC LIMIT $offset , $records_no_per_page ";
}
        ...
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">
              <i class="fa fa-th-list fa-fw"></i>Medical
              <span class="pull-right" style="margin-top: -7px;">
                <a id="add_property_button" type="button" name="button" class="btn btn-success" href="add_medical.php">
            ...
            <div class="panel-body">
              ...
              <div class="table-responsive" id="reportData">
                <table class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr class="info">
                      <th colspan="15" class="text-center"> Medical</th>
                    </tr>
                    <tr>
                      <th>Date</th>
                      <th>Adm No</th>
                  ...
                  <tbody>
                    ...
                    foreach ($table_rows as $row) { ?>
                      <tr>
                        ...
                        <?php
                        $status = ($row->status == 0) ? "ACTIVE" : "CLEARED";
                        ?>
                        <td><?php echo $status; ?></td>
                        <td>
                          <a href="detail_medical.php?med_id=<?php echo $row->id; ?>"
